...
if __name__=="__main__":
    ...
    raw_path = '/home/ujinne/workspaces/datasets/speaker_id/raw_data'
    ...
    # extract_path = '/home/ujinne/workspaces/datasets/speaker_id/extracted_data'
    n_spk = 300
    ...
    for file_path in tqdm(enrolled_speakers):
        ...
        # copy_path = f'{extract_path}/{spk_id}'
        # os.makedirs(copy_path, exist_ok=True)
        # shutil.copyfile(file_path, f'{copy_path}/{filename}.wav')
    ...
    # Model load
    classifier = EncoderClassifier.from_hparams(source="/home/ujinne/workspaces/projects/speaker/results/spkrec-ecapa") # speechbrain/spkrec-ecapa-voxceleb
    ...
    # Test enrolled speakers(with noise) + impostor speakers data
    ...
    # print(len(test_data))
    logger = get_logger(name=f'Speaker Recognition', file_path=f'speaker_recognition.log', stream=True)
    
    print("Getting Speaker Recognition Results...")
    preds = []
    test_embs = []
    ...
    logger.info("="*100)
    logger.info(f'EER(Equal Error Rate) : {eer*100:.4f} (%)')
    logger.info("="*100)
    print()
